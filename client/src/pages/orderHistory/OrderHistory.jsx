...
export const OrderHistory = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cyan-100 to-white py-12 px-4 sm:px-6 lg:px-8">
      {loading ? (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <h3 className="text-xl font-semibold text-cyan-800  text-center">
