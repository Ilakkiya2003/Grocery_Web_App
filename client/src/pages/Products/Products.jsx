...
export const Products = ({ searchQuery }) => {
  ...
  return (
    <div
      ref={productsRef}
      className="min-h-screen bg-gradient-to-b from-cyan-100 to-white py-12 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <ScrollArea className=" md:h-screen w-auto rounded-md border">
            ...
            <Card className="hidden   md:block w-64 h-fit sticky top-4">
              <CardHeader>
                ...
                <Button
                  className="flex items-center gap-2 text-cyan-700 font-medium"
                  onClick={() => {
                    setSelectedBrands([]);
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label className="text-cyan-700 mb-2 block">
                    Price Range
                  </Label>
                  <Slider
                    min={0}
                ...
                <div>
                  <Label className="text-cyan-700 mb-2 block">Brands</Label>
                  {brands.map((brand) => (
                    <div
                      key={brand}
                      className="flex items-center space-x-2 mb-2"
          ...
          <Button
            className="md:hidden fixed bottom-4 right-4 z-10 bg-green-500 hover:bg-blue-600 text-white rounded-full shadow-lg"
          ...
          {isFilterOpen && (
            <div className="fixed inset-0 bg-black bg-opacity-50 z-50 md:hidden">
              <div className="absolute right-0 top-0 bottom-0 w-64 bg-white p-4 overflow-y-auto">
                ...
                <Button
                  className="flex mx-auto my-3 rounded-full items-center gap-2 text-cyan-700 font-medium"
                  onClick={() => {
                    setSelectedBrands([]);
                    setSelectedCategories([]);
                    setPriceRange([0, 10000]);
            ...
            <div className="flex-1">
              {products.length > 0 ? (
                ...
                <Card className="p-8 text-center">
                  <CardTitle className="text-2xl font-semibold text-cyan-800 mb-4">
                    No Products Found
                  </CardTitle>
