...
export default function Navbar({ setSearchQuery }) {
  ...
  return (
    <nav className="bg-gradient-to-r from-indigo-400 to-teal-500 p-4 shadow-lg">
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to={"/"}>
            <div className="text-2xl font-bold flex items-center gap-2 text-white"><ShoppingBasket/>Harvest Hub</div>
          </Link>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              >
                ...
                <nav className="flex flex-col space-y-4 mt-8">
                  ...
                  <Button
                    variant="ghost"
                    className="justify-start text-purple-700 hover:bg-purple-100"
                    onClick={() => {
                      navigate("/settings");
                      closeSheet();
                    }}
                  ...
                  {isAuth ? (
                    ...
                    <Button
                      variant="ghost"
                      className="justify-start text-volite-700 hover:bg-volite-100"
                      onClick={() => {
                        navigate("/signin");
                        closeSheet();
                      }}
