...
export const DropDownProfile = () => {
  ...
  return (
    <Button
      ...
      className="flex items-center space-x-2 rounded-full px-4 py-2 text-sm font-medium bg-blue-500 text-white hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
    >
      <UserCircle className="h-5 w-5" />
      <span>Sign In</span>
    </Button>
