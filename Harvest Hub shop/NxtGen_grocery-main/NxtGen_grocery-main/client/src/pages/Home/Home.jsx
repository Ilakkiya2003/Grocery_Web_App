...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-indigo-400 to-teal-500 rounded-lg shadow-lg p-8 mb-12">
      ...
      <section className="text-center mb-12">
        ...
        <Link to={"/products"}>
          <Button className="bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-6 rounded-full text-lg">
            Explore Products
          </Button>
        </Link>
      </section>
