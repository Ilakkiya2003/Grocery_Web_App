...
export const SignIn = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cyan-100 to-white flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-bold text-center text-purple-700">
            LogIn to Harvest Hub
          </CardTitle>
          <CardDescription className="text-center text-puple-600">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-black-600">
                Or continue with
              </span>
            </div>
          </div>
          <form onSubmit={handleSignin} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="pl-10 border-black-300 focus:border-purple-500 focus:ring-black-500"
                  required
                />
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-indigo-500 hover:bg-volit-600 text-white"
            >
