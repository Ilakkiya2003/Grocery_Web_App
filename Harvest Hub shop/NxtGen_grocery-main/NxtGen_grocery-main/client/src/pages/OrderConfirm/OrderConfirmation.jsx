...
export const OrderConfirmation = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue100 to-white py-12 px-4 sm:px-6 lg:px-8">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {paymentMethod === "stripe" && (
                  <form className="flex flex-col ">
                    ...
                    <Button
                      ...
                      className="mt-4 w-full  bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-3 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
                ...
                {paymentMethod === "cod" && (
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-6 bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-3 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
                  >
                    {loading && (
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    )}
            ...
            <CardContent>
              <ul className="space-y-4">
                {orderItems.map((item) => (
                  ...
                  >
                    <div>
                      <p className="font-medium text-cyan-800">{item.name}</p>
              ...
              <div className="flex justify-between text-lg font-bold">
                <p className="text-cyan-800">Total</p>
                <p className="text-cyan-800">${total.toFixed(2)}</p>
              </div>
            </CardContent>
          </Card>
        </div>
