              ...
              <ScrollArea className="h-screen pr-4">
                <CardHeader className="p-0 mb-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-3xl font-bold text-cyan-800 mb-2">
                        {product.name}
                      </CardTitle>
                      <CardDescription className="text-lg text-cyan-600">
                        {product.category}
                      </CardDescription>
                    </div>
                    {product.isOrganic && (
                      <Badge
                        variant="secondary"
                        className="bg-cyan-100 text-indigo-800"
                      >
                ...
                <CardContent className="p-0">
                  ...
                  <p className="text-cyan-800 mb-6">{product.description}</p>
                  ...
                  <ul className="list-disc list-inside text-cyan-700 mb-6">
                  ...
                  <table className="w-full text-cyan-700 mb-6">
                    <tbody>
                      <tr>
                        <td>Calories:</td>
